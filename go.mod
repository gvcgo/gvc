...
require (
	...
	github.com/moqsien/neobox v0.0.2
...
require (
	...
	github.com/Asutorufa/yuhaiin v0.3.1-rc.8 // indirect
	...
	github.com/sagernet/sing-box v1.2.7 // indirect
	...
	gvisor.dev/gvisor v0.0.0-20230506005148-9538f1385f75 // indirect
